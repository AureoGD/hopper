...
class ModelMatrices:
    ...
    def update_homog_trans(self):
        ...
        self.HT_heel[2, 3] = 0.26 * sin_vals[2] - 0.05 * cos_vals[2] - 0.45 * cos_vals[0] - 0.5 * cos_vals[1]
    ...
    def update_jacobians(self):
        ...
        self.J_heel[2, 0] = 0.26 * cos_vals[2] + 0.05 * sin_vals[2] + 0.45 * sin_vals[0] + 0.50 * sin_vals[1]
        self.J_heel[2, 1] = 0.26 * cos_vals[2] + 0.05 * sin_vals[2] + 0.50 * sin_vals[1]
        self.J_heel[2, 2] = 0.26 * cos_vals[2] + 0.05 * sin_vals[2]
    ...
    def update_CoM_jacobians(self, _qr):
        J_com1 = np.zeros((3, 3))
        J_com2 = np.zeros((3, 3))
        J_com3 = np.zeros((3, 3))

        sin_vals, cos_vals = self.compute_sin_cos([_qr[0], _qr[0] + _qr[1], _qr[0] + _qr[1] + _qr[2]])
