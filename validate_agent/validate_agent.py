...
model_path = "agents/DNN/1744666745/models/best_model_1.zip"
# model_path = "agents/DNN/1744659567/models/ppo_model_860160.zip"
...
print(f"Success count (interaction > 1250): {success}/{n_episodes}")
