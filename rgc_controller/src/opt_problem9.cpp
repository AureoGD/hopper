...
OptProblem9::OptProblem9(ModelMatrices *Robot) : RobotMtx(Robot)
{
...
OptProblem9::~OptProblem9()
{
}

void OptProblem9::UpdateModelConstants()
{
...
void OptProblem9::UpdateDynamicModel()
{
...
void OptProblem9::DefineConstraintMtxs()
{
