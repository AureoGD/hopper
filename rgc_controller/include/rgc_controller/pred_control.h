...
public:
    ...
    Eigen::MatrixXd A, B, Aa, Ba, Ca, C_cons, C_consV;
    ...
    // private:
    Eigen::MatrixXd G, Phi, G_cons, Phi_cons, Q_block, R_block, Uc_block, Lc_block, Ref_block, aux_mdl, aux_cons, Ucv_block, Lcv_block, Lcv_var, Ucv_var;

    Eigen::VectorXd x;

    int nx, nxa, ny, nu, nc, ncv;
};
#endif